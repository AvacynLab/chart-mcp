...
class BacktestEngine:
    ...
    def run(
        ...
        *,
        ...
        fast_ma = closes.rolling(window=strategy.fast_window, min_periods=strategy.fast_window).mean()
        slow_ma = closes.rolling(window=strategy.slow_window, min_periods=strategy.slow_window).mean()
    ...
    def _compute_metrics(
        ...
        *,
        ...
        profit_factor = float(wins.sum() / abs(losses.sum())) if losses.sum() != 0 else float(wins.sum())
